...
from IO.utils.inline.stats import back_stats_buttons, stats_buttons
...
async def overall_stats(client, CallbackQuery, _):
    ...
    med = InputMediaPhoto(media=config.STATS_IMAGE, caption=text)
    try:
        await CallbackQuery.edit_message_media(media=med, reply_markup=upl)
    except MessageIdInvalid:
        await CallbackQuery.message.reply_photo(
            photo=config.STATS_IMAGE, caption=text, reply_markup=upl
        )
